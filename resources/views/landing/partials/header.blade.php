<header class="tx-header" id="txHeader">
  <div class="tx-container tx-header__inner">
    ...
    <nav class="tx-nav" aria-label="التنقل الرئيسي">
      ...
      <a class="tx-nav__link" href="{{ url('/#why') }}" data-nav-section="why">لماذا TX-SaaS</a>
      <a class="tx-nav__link" href="{{ url('/#process') }}" data-nav-section="process">المنهجية</a>
      <a class="tx-nav__link" href="{{ url('/#work') }}" data-nav-section="work">الأعمال</a>
...
<div class="tx-drawer" id="txDrawer" aria-hidden="true">
  ...
  <div class="tx-drawer__panel" role="dialog" aria-modal="true" aria-label="قائمة التنقل">
    ...
    <div class="tx-drawer__links">
      ...
      <a href="{{ url('/#why') }}" data-close-drawer>لماذا TX-SaaS</a>
      <a href="{{ url('/#process') }}" data-close-drawer>المنهجية</a>
      <a href="{{ url('/#work') }}" data-close-drawer>الأعمال</a>
